...
EMAIL_PORT = 25
#发送邮件的邮箱
EMAIL_HOST_USER = 'guoqiang951212@163.com'
#在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'GQ70860828'
#收件人看到的发件人
EMAIL_FROM = '美多商城<guoqiang951212@163.com>'
...
CRONJOBS = [
    # 每5分钟执行一次生成主页静态文件
    ('*/1 * * * *', 'contents.crons.generate_static_index_html', '>> /home/python/Desktop/manoeuvre/meiduo/logs/crontab.log')
    # (时间间隔，执行的任务，log日志路径)
]
